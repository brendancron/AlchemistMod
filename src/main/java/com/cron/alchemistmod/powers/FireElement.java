...
public class FireElement extends AbstractElement {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(AlchemistMod.makePowerPath(FireElement.class.getSimpleName() + "84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(AlchemistMod.makePowerPath(FireElement.class.getSimpleName() + "32.png"));

    public FireElement(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        super(owner, source, amount, Element.FIRE);

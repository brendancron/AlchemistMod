...
public class CommonSkill extends CustomCard {
    ...
    public final static String ID = AlchemistMod.makeID(CommonSkill.class.getSimpleName());
    public static final String NAME = InsertSpacesIntoString.insertSpacesIntoString(CommonSkill.class.getSimpleName());

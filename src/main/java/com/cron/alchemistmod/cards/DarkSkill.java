...
public class DarkSkill extends CustomCard {
    ...
    public final static String ID = AlchemistMod.makeID(DarkSkill.class.getSimpleName());
    ...
    public static final String IMG_PATH = AlchemistMod.makeCardPath(DarkSkill.class.getSimpleName() + ".png");

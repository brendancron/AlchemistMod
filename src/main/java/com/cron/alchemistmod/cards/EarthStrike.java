...
public class EarthStrike extends AbstractAlchemistCard {
    ...
    public static final String IMG_PATH = AlchemistMod.makeCardPath(EarthStrike.class.getSimpleName() + ".png");

...
public class UncommonPower extends CustomCard {
    ...
    public final static String ID = AlchemistMod.makeID(UncommonPower.class.getSimpleName());
    public static final String NAME = InsertSpacesIntoString.insertSpacesIntoString(UncommonPower.class.getSimpleName());

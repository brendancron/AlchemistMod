...
public class LiquidShield extends AbstractAlchemistCard {
    ...
    public static final String IMG_PATH = AlchemistMod.makeAlchemistCardPath(LiquidShield.class.getSimpleName() + ".png");

    public LiquidShield() {
        super(ID, CARD_STRINGS.NAME, LiquidShield.class, COST, CARD_STRINGS.DESCRIPTION, TYPE, COLOR, RARITY, TARGET);

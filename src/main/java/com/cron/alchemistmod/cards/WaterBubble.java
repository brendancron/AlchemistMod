...
public class WaterBubble extends AbstractAlchemistCard {
    ...
    public static final String IMG_PATH = AlchemistMod.makeCardPath(WaterBubble.class.getSimpleName() + ".png");

...
public class Earthquake extends AbstractAlchemistCard {
    ...
    public static final String ID = AlchemistMod.makeID(Earthquake.class.getSimpleName());
    public static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);

    public Earthquake() {
        super(ID, CARD_STRINGS.NAME, Earthquake.class, COST, CARD_STRINGS.DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
            new ApplyPowerAction(p, p, new TremorPower(p, p, this.magicNumber), this.magicNumber)
        );
    }

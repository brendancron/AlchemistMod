...
public class Caffeine extends AbstractAlchemistCard {
    ...
    public static final String ID = AlchemistMod.makeID(Caffeine.class.getSimpleName());
    public static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);

    public Caffeine() {
        super(ID, CARD_STRINGS.NAME, Caffeine.class, COST, CARD_STRINGS.DESCRIPTION, TYPE, COLOR, RARITY, TARGET);

...
public class SearingLight extends AbstractAlchemistCard {
    ...
    public static final String IMG_PATH = AlchemistMod.makeAlchemistCardPath(SearingLight.class.getSimpleName() + ".png");

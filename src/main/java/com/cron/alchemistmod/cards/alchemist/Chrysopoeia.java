...
public class Chrysopoeia extends AbstractAlchemistCard {
    ...
    public static final String ID = AlchemistMod.makeID(Chrysopoeia.class.getSimpleName());
    public static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);

    public Chrysopoeia() {
        super(ID, CARD_STRINGS.NAME, Chrysopoeia.class, COST, CARD_STRINGS.DESCRIPTION, TYPE, COLOR, RARITY, TARGET);

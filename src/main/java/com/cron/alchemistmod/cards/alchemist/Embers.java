...
public class Embers extends AbstractAlchemistCard {
    ...
    public static final String IMG_PATH = AlchemistMod.makeAlchemistCardPath(Embers.class.getSimpleName() + ".png");

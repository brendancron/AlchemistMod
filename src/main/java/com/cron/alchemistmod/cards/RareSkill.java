...
public class RareSkill extends CustomCard {
    ...
    public final static String ID = AlchemistMod.makeID(RareSkill.class.getSimpleName());
    public static final String NAME = InsertSpacesIntoString.insertSpacesIntoString(RareSkill.class.getSimpleName());
